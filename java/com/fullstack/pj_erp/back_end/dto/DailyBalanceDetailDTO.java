...
@Entity
@Data
@Table(name = "DAILYBALANCEDETAIL")
public class DailyBalanceDetailDTO {

	@Id // PK, 일계표 아이디
	@Column(name = "DAILYBALANCEDETAILID")
	private String dailyBalanceDetailId;
	@Column(name = "DAILYTRIALID") // FK
	private String dailyTrailId;
	...
	private void generateId() {
		...
		this.dailyBalanceDetailId = "DBD" + key + dailyBalanceDetailId;
		System.out.println("daily balance detail ID : " + dailyBalanceDetailId);
	}
